---
title: Estimating the association between Facebook adoption and well-being
...
Both datasets (Facebook and Gallup) are proprietary and we therefore could not share them with this manuscript. Our analytic code, along with synthetic datasets, is available at (LINK). Researchers can contact Facebook (ccobb@fb.com) to reproduce our analyses with the actual Facebook adoption dataset. The Gallup data are available online to subscribing institutions.
